...
# https://github.com/dblock/vectordb-hello-world/blob/main/src/redis/hello.py
...
def main():
    r = Redis(host='<YOUR_URL>',port=14688,password='<YOUR_PASSWORD>', decode_responses=True)
